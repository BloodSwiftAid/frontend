          ...
          >
            <div className="flex justify-between items-start mb-12">
              ...
              <button 
                ...
                className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest cursor-pointer hover:opacity-80 transition-opacity ${hosp.is_verified ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20' : 'bg-accent/10 text-accent border border-accent/20'}`}
              >
                {hosp.is_verified ? 'Verified (Revoke)' : 'Verify Facility'}
              </button>
            </div>
