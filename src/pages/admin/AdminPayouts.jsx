    ...
    <div className="p-8 md:p-12 space-y-12 animate-fade-in relative z-10 pb-24">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h1 className="text-5xl font-black tracking-tighter text-text-primary uppercase leading-none">
            Settlement <span className="text-gradient">Hub</span>
          </h1>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button 
            ...
            className="flex items-center gap-3 bg-accent text-white px-8 py-4 rounded-2xl hover:scale-105 transition-all shadow-xl shadow-accent/20"
          >
            <ArrowUpRight className="w-4 h-4" />
            <span className="text-[10px] font-black uppercase tracking-widest">Initiate Payout</span>
          </button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-card-bg/40 backdrop-blur-xl border border-accent/20 p-8 rounded-[40px] relative overflow-hidden group">
          ...
          <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em] mb-2">Commission Balance</p>
        ...
        <div className="bg-card-bg/40 backdrop-blur-xl border border-glass-border p-8 rounded-[40px] relative overflow-hidden group">
          ...
          <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em] mb-2">Total Disbursed</p>
      ...
      <div className="bg-card-bg/40 backdrop-blur-3xl border border-glass-border rounded-[48px] overflow-hidden flex flex-col shadow-2xl">
         <div className="p-10 border-b border-glass-border flex justify-between items-center bg-glass/20">
          <div>
            ...
            <p className="text-[10px] font-black text-text-muted uppercase tracking-widest mt-2">Cross-facility settlement telemetry</p>
          </div>
           ...
           <table className="w-full text-left">
            <thead>
              <tr className="bg-glass/50 border-b border-glass-border">
                ...
                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-secondary">Fee Meta</th>
                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-secondary">Status</th>
                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-secondary">Audit Timestamp</th>
              </tr>
            </thead>
        ...
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6 backdrop-blur-xl bg-bg-dark/80 animate-fade-in">
          <div className="bg-card-bg border border-glass-border w-full max-w-xl rounded-[56px] p-12 shadow-2xl relative overflow-hidden animate-slide-up">
            ...
            <header className="mb-12">
              <h2 className="text-3xl font-black text-text-primary uppercase tracking-tighter">Initiate Settlement</h2>
            ...
            <form onSubmit={handleRequestPayout} className="space-y-8">
              <div className="space-y-4">
                <label className="text-[10px] font-black text-text-muted uppercase tracking-widest ml-4">Target Payout Account</label>
                <select 
                  required
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-text-muted uppercase tracking-widest ml-4">Disbursement Amount</label>
                ...
                <p className="text-[9px] font-black text-text-muted uppercase tracking-widest ml-4 flex justify-between">
                  <span>Available for withdrawal</span>
                  <span className="text-accent">₦{parseFloat(walletBalance).toLocaleString()}</span>
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                >
                  {processing ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : "Authorize Transfer"}
                </button>
                <button 
                  type="button" 
            ...
            <div className="mt-8 p-6 bg-amber-500/10 border border-amber-500/20 rounded-3xl flex items-start gap-4">
               ...
               <p className="text-[9px] font-black text-text-secondary uppercase leading-relaxed opacity-80">
                 Authorization will trigger immediate fund transfer via Paystack infrastructure. 
                 Final settlement relies on asynchronous gateway verification (Webhooks).
               </p>
            </div>
          </div>
        </div>
