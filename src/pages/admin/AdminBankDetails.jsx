    ...
    <div className="p-8 md:p-12 space-y-12 animate-fade-in relative z-10 pb-24">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex items-center gap-6">
          <Link to="/admin/payouts" className="p-4 bg-glass border border-glass-border rounded-2xl hover:text-accent transition-all group">
            <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
          </Link>
          <div>
            <h1 className="text-5xl font-black tracking-tighter text-text-primary uppercase leading-none">
              Treasury <span className="text-gradient">Accounts</span>
            </h1>
        ...
        {banks.length < 3 && (
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Register Account</span>
          </button>
        )}
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        {/* Right Column: Add Bank Form (Visible only when showAdd is true) */}
